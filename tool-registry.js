...
import { isLorebookEnabled, getSettings, syncTrackerUidsForLorebook } from './tree-store.js';
...
export async function registerTools() {
    // Always rebuild from a clean slate so stale definitions never survive toggles or tree-state changes.
    unregisterTools();
